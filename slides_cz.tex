...
\begin{frame}\frametitle{Motivace}
  \makebox[\linewidth]{
    \begin{tikzpicture}
      \node (screenshot) 
         {\includegraphics[height=0.9\paperheight]{img/lorem_ipsum_1.png}};
      \pause
      \node (schema) at (screenshot)
         {\includegraphics[height=0.9\paperheight]{img/lorem_ipsum_2.png}};\onslide<1->
    \end{tikzpicture}
  }
\end{frame}
    ...
    \column{0.6\textwidth}
      ...
      \makebox[\textwidth]{
        \begin{tikzpicture}
          \onslide<1>
          \node (result_1)
            {\includegraphics[width=\textwidth]{img/result_1.png}};
          \onslide<2>
          \node (result_2) at (result_1)
            {\includegraphics[width=\textwidth]{img/result_2.png}};
          \onslide<3>
          \node (result_3) at (result_1)
            {\includegraphics[width=\textwidth]{img/result_3.png}};
          \onslide<4>
          \node (result_4) at (result_1)
            {\includegraphics[width=\textwidth]{img/result_4.png}};
          \onslide<5>
          \node (result_5) at (result_1)
            {\includegraphics[width=\textwidth]{img/result_5.png}};
          \onslide<6>
          \node (result_6) at (result_1)
            {\includegraphics[width=\textwidth]{img/result_6.png}};
          \onslide<7->
          \node (result_7) at (result_1)
            {\includegraphics[width=\textwidth]{img/result_7.png}};
          \onslide<1->
        \end{tikzpicture}
      }
  \end{columns}
...
\begin{frame}
  ...
  \makebox[\textwidth]{
    \begin{tikzpicture}
      \node (overflow)
         {\frame{\includegraphics[width=0.6\paperwidth]{img/result_end_1.png}}};
      \pause
      \node (image) at (2,2)
        {\frame{\includegraphics[width=0.5\paperwidth]{img/result_end_2.png}}};
      \pause
      \node (hyphen) at (-2,-1.5)
         {\frame{\includegraphics[width=0.5\paperwidth]{img/result_end_3.png}}};
      
      \pause
      \node (cmd_line) at (-1,3)
          {\frame{\includegraphics[width=0.75\paperwidth]{img/cmd_screenshot_many.pdf}}};
      \pause
    ...
    \makebox[\textwidth]{
      \begin{tikzpicture}
        ...
        \node (image_check) at (website.south east) [yshift=2ex]
          {\includegraphics[width=0.4\paperwidth]{img/result_end_2.png}};
