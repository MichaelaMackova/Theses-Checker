...
\lstdefinestyle{myPython}{
  ...
  captionpos=b,
  emph=[2]{currPage, overflowList, pageBorder, pagePicture, lineOfPixels, pixel},
  %emphstyle=[2]{\color{cyan}},
  emph=[3]{getOverflow, getPageBorder, getPageAsPicture, outOfBounds, add,
    annotate, getDocInfo, Check1, Check2, save, findPageBorder, firstLine,
    lastLine, median},
  emphstyle=[3]{\color{violet}},
}

\lstdefinelanguage{PDF}{
  morekeywords={stream, endstream, xref, trailer, startxref},
  sensitive=true,
  morecomment=[l]\%,
  alsoletter={/,(,)},
  literate=%
    ...
    {ŕ}{{\'r}}1
    {ś}{{\'s}}1
    {endobj}{{{\bfseries\color{purple}endobj}}}6
    {12\ 0\ obj}{{{\bfseries\color{purple}12 0 obj}}}8
    {7\ 0\ obj}{{{\bfseries\color{purple}7 0 obj}}}7
    {3\ 0\ obj}{{{\bfseries\color{purple}3 0 obj}}}7
    {5\ 0\ obj}{{{\bfseries\color{purple}5 0 obj}}}7
    {21\ 0\ obj}{{{\bfseries\color{purple}21 0 obj}}}8
    {46\ 0\ obj}{{{\bfseries\color{purple}46 0 obj}}}8
}

\lstdefinestyle{myPDF}{
  language=PDF,
  basicstyle=\fontfamily{newtxtt}\small,
  %numbers=left,
  %numberstyle=\scriptsize,
  ...
  captionpos=b,
  emph=[2]{/Length, /Filter, /FlateDecode, /Size, /Root, /Info, /Type, /Catalog,
    /Pages, /Kids, /Count, /Page, /MediaBox, /Parent, /Contents, /Resources, /Font, 
    /F5, /XObject, /Im1, /Im2, /Annot, /Subtype, /Text, /Name, /Note, /Rect, /Dest, 
    /XYZ, /Link},
...
\projectinfo{
  ...
  keywords.cs={PDF, typografické chyby, časté chyby, technická zpráva, webová aplikace, PDF anotace, Django, Python, struktura PDF}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={PDF, typographical mistakes, frequent mistakes, technical paper, web application, PDF annotations, Django, Python, PDF structure}, % klíčová slova v anglickém jazyce / keywords in english
  %keywords.en={Here, individual keywords separated by commas will be written in English.},
  % Abstrakt / Abstract
  abstract.cs={Cílem této práce je vytvoření aplikace, která zkontroluje technickou
      zprávu a~označí všechny nalezené chyby pomocí PDF anotací. 
      Technická dokumentace této práce rozebírá strukturu PDF souboru, často
      se vyskytující chyby v~diplomových pracích, vývoj webu s~pomocí
      frameworku Django a~probírá existující knihovny pro úpravu PDF dokumentů.
      Výsledná aplikace je
      implementována v~jazyku Python a~s~pomocí frameworku Django je přístupná jako
      webový nástroj. Vytvořené řešení dokáže nalézt šest převážně typografických chyb,
      které se často vyskytují v~diplomových pracích. Nalezené chyby jsou graficky
      označeny a~upravený PDF soubor je poté zobrazen přímo na webové stránce.
      Výsledný nástroj je volně dostupný a~pomáhá studentům i~vyučujícím při
      kontrole vytvářených technických zpráv.
...
% I have listed all the literary sources, publications and other sources, which were used during the preparation of this thesis.},
  ...
  acknowledgment={Ráda bych touto cestou poděkovala panu Ing.~Tomáši Miletovi, Ph.D. 
  za jeho ochotu a~cenné rady při vedení mé bakalářské práce. Dále bych chtěla poděkovat
  své rodině a~blízkým přátelům za jejich podporu při studiu. Především bych chtěla 
  poděkovat svým rodičům Martinovi a~Miluši za to, že mi umožnili studovat vysokou
  školu a~Ivanovi Mudrákovi za jeho nekonečnou trpělivost s~mou maličkostí.},
...
\begin{document}
  ...
  \else
    \input{xmacko13-Kontrola-diplomovych-praci-01-kapitoly-chapters}
  \fi
...
\fi
  ...
  \else
    \input{xmacko13-Kontrola-diplomovych-praci-30-prilohy-appendices}
  \fi
