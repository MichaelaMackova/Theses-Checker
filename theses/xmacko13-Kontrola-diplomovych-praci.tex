...
\projectinfo{
  ...
  abstract.cs={Cílem této práce je vytvoření aplikace, která zkontroluje technickou
      zprávu a~označí všechny nalezené chyby pomocí PDF anotací. Aplikace je
      implementována v~jazyku Python a~pomocí frameworku Django je přístupná jako
      ...
      Výsledný nástroj je volně dostupný a~pomáhá uživatelům při kontrolování textu
      své vytvářené technické zprávy.
  }, % abstrakt v českém či slovenském jazyce / abstract in czech or slovak language
  abstract.en={Do tohoto odstavce bude zapsán výtah (abstrakt) práce v anglickém jazyce. \todo{TODO:}
