...
\todo{webová aplikace, nákresy webovky, princip nahrát -> zpracovat -> ukázat, cílová skupina?, }

\begin{figure}[H]
    \label{pic_theses_checker_dia}
    \centering
    \includegraphics[width=0.8\linewidth]{obrazky-figures/Theses_Checker_diagram.pdf}
    \caption{\todo{TODO: odkaz}}
\end{figure}
...
Hlavní funkce \texttt{annotate()} přijímá parametry typu boolean, kde
...
%---------- 4.3.1 Extrahovaný text ve formátu pro čtení ----------
...
\todo{pseudokód, popsat princip, blbne u textových objektů (tabulka, listing, grafy?)}
...
\todo{pseudokód, popsat princip, funkčí pouze pro Form XObjects}
...
\todo{je to něco navíc, musí se instalovat python a pymupdf, jak to nainstalovat, aby to fungovalo, ukázka použití, proč to vůbec vzniklo (hromadná oprava)}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[]{obrazky-figures/Theses_Checker_communication.pdf}
...
\todo{TODO: vylepšení: proměnná \texttt{\_\_currPageTextContent} nebude obsahovat z embedded pdfs}
