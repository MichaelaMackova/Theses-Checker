...
\todo{itemize; přeformulovat na množné, jelikož existují dvě verze (cmd, web)}
...
\begin{figure}[H]
    ...
    \caption{\todo{Graf s novými odpovědmi + popisy os}Obrázek obsahuje graf odpovědí na otázku o~přehlednosti
...
%\todo{TODO: okraj stránky pro oboustranný tisk}
...
%\todo{TODO: hledání nevhodných slov, proměnná \texttt{\_\_currPageTextContent} nebude obsahovat z embedded pdfs}
...
špatné použití spojovníku, nevhodná šířka obrázku, vynechaná mezera před levou
závorkou, chybějící text mezi názvy sekcí a~odkaz na neexistující referenci.
Byl vytvořen plakát a~video\footnote{\todo{TODO: odkaz na video}}, které
...
\todo{práce byla ukázána na konferenci excel@fit; zmínit i cmd program}
