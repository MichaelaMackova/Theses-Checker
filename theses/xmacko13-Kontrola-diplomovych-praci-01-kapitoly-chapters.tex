...
\newcommand{\pdfcode}[1]{
    ...
    \noindent\begin{minipage}{\linewidth}
        \lstinputlisting[xleftmargin=.25in]{#1}
    \end{minipage}
...
\begin{itemize}
    ...
    například:
    \pdfcode{code_examples/stream_objects.txt}
...
například:
\pdfcode{code_examples/indirect_object.txt}
...
\begin{itemize}
    ...
    \pdfcode{code_examples/cross_reference_table.txt}
    ...
    \pdfcode{code_examples/trailer.txt}
...
\begin{itemize}
    ...
    může být například:
    \pdfcode{code_examples/document_catalog.txt}
    ...
    \pdfcode{code_examples/page_tree.txt}
    ...
    \pdfcode{code_examples/page_object.txt}
\end{itemize}
...
\pdfcode{code_examples/resources.txt}
