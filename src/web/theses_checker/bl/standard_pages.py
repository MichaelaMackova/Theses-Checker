...
IMAGE_AREA_TO_STD_PAGE = 163.64 ## conversion ratio from image area (cm^2) to standard pages (picture_area [cm^2] / IMAGE_AREA_TO_STD_PAGE [cm^2] = number_of_standard_pages); approx. 11 characters per cm^2
#TODO: old ratio 15.5 * 22.5 -> new ratio: cm2 / 163.64
